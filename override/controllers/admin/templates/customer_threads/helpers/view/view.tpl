                ...
                <div class="media-body">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <ul>
                                <li>Nom : {$thread->lastname}</li>
                                <li>Prénom : {$thread->firstname}</li>
                                <li>Fonction : {$thread->fonction}</li>
                                <li>Téléphone : {$thread->phone}</li>
                                <li>Fax : {$thread->fax}</li>
                                <li>Département : {$thread->department}</li>
                                <li>Ville : {$thread->city}</li>
                            </ul>
