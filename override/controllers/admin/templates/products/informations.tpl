...
<div id="product-informations" class="panel product-tab">
    ...
    <div class="form-group">
        <label class="control-label col-lg-3" for="adv_video_link">
			<span class="label-tooltip" data-toggle="tooltip"
                  title="{l s='Lien de la video (youtube)'}">
				{l s='Vidéo'}
			</span>
        </label>
        <div class="col-lg-9">
            <input type="text" name="adv_video_link" value="{$product->adv_video_link}" />
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="control-label col-lg-3" for="adv_avantages">
			<span class="label-tooltip" data-toggle="tooltip"
                  title="{l s='Appears in the body of the product page.'}">
				{l s='Avantages'}
			</span>
        ...
        <div class="col-lg-9">
            <textarea name="adv_avantages" class="autoload_rte">
                {$product->adv_avantages}
            </textarea>
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-lg-3" for="adv_applications">
			<span class="label-tooltip" data-toggle="tooltip"
                  title="{l s='Appears in the body of the product page.'}">
				{l s='Applications'}
			</span>
        ...
        <div class="col-lg-9">
            <textarea name="adv_applications" class="autoload_rte">
                {$product->adv_applications}
            </textarea>
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-lg-3" for="adv_accessoires">
			<span class="label-tooltip" data-toggle="tooltip"
                  title="{l s='Appears in the body of the product page.'}">
				{l s='Accessoires'}
			</span>
        ...
        <div class="col-lg-9">
            <textarea name="adv_accessoires" class="autoload_rte">
                {$product->adv_accessoires}
            </textarea>
        </div>
    </div>

    <div class="form-group">
        <label class="control-label col-lg-3" for="adv_references">
			<span class="label-tooltip" data-toggle="tooltip"
                  title="{l s='Appears in the body of the product page.'}">
				{l s='References'}
			</span>
        ...
        <div class="col-lg-9">
            <textarea name="adv_references" class="autoload_rte">
                {$product->adv_references}
            </textarea>
        </div>
    </div>
