...
class ContactController extends ContactControllerCore
{
    ...
    */
            ...
            if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
                ...
                if ($contact->customer_service) {
                    if ((int)$id_customer_thread) {
                        ...
                        $ct->lastname = Tools::getValue('lastname');
                        $ct->fonction = Tools::getValue('fonction');
                        $ct->phone = Tools::getValue('phone');
                        $ct->fax = Tools::getValue('fax');
                        $ct->department = Tools::getValue('department');
    ...
    {
        parent::initContent();
        $this->context->smarty->assign('path', 'Contact');
    }
