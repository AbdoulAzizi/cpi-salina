...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="product_desc container">
	    <div class="row">
	        ...
	        <div class="col-md-8 col-md-offset-1">
	        	...
	        	{/if}
	        	{if $product->id_category_default != $smarty.const._ACCESSOIRES_CATEGORY_ID_}
	...
	<section class="verylightgrey section-product">
		<div class="container">	
			...
			<div class="pb-left-column col-xs-12 col-sm-4">
				...
				{if (isset($images) && count($images) > 0) || $product->getVideoCode()}
					<!-- thumbnails -->
					<div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
						...
						<div id="thumbs_list">
							...
							<!-- ******** VIDEO ********* -->
                            {if $product->getVideoCode() }
                                <li id="thumbnail_video_link">
                                    <a href="#" class="video-link" title="Video" data-video="{$product->adv_video_link}"> 
                                ...
                                <script>
                                    $(document).ready(function(){
                                        $('.video-link').fancybox({
                                            content:'<iframe width="420" height="315" src="https://www.youtube.com/embed/{$product->getVideoCode()}" frameborder="0" allowfullscreen></iframe>'
                                        });
                                    });
                                </script>
			...
			<div class="pb-right-column col-xs-12 col-sm-8">
				...
				<div>
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    <li role="presentation" class="active"><a href="#avantages" aria-controls="avantages" role="tab" data-toggle="tab">Avantages</a></li>
				  ...
				  <div class="tab-content">
				    <div role="tabpanel" class="tab-pane fade in active" id="avantages">
				    	{if $product->adv_avantages}
	        				<div id="short_description_content" class="rte align_justify" itemprop="description">{$product->adv_avantages}</div>
	        			{/if}
				    </div>
				    <div role="tabpanel" class="tab-pane fade" id="applications">
				    	{if $product->adv_applications}
	        				<div id="short_description_content" class="rte align_justify" itemprop="description">{$product->adv_applications}</div>
	        			{/if}
				    </div>
				    ...
				    <div role="tabpanel" class="tab-pane fade" id="accessoires">
				    	{if $product->adv_accessoires}
	        				<div id="short_description_content" class="rte align_justify" itemprop="description">{$product->adv_accessoires}</div>
	        			{/if}
				    </div>
				  </div>
				...
				<p class="hidden" id="product_reference"{if empty($product->reference) || !$product->reference} style="display: none;"{/if}>
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
	...
	*}
	...
	<section class="section-reference">
		<div class="container">
			{if $product->adv_references}
				<h2 class="border-light">Références <strong>pompes</strong></h2>
				<div id="short_description_content" class="rte align_justify" itemprop="description">{$product->adv_references}</div>
			{/if}
		</div>
	</section>
