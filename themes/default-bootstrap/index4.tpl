...
<section class="carousel-marques">
    <div class="container">
        ...
        <div class="responsive">
            ...
            {*<div><img src="{$img_dir}marques/krautzberger.jpg" alt="marque"></div>*}
...
<section class="bottom-home">
    <div class="container">
        <p><strong>Depuis 1968 et en partenariat avec les plus grands constructeurs mondiaux</strong> (ARO, GRUNDFOS, PRORIL, MOUVEX, HILGE), CPI-SALINA avec ses équipes techniques et
            commerciales vous proposent le matériel de pompage le plus performant pour transférer vos liquides, quelle que soit leur nature (viscosité, densité, température).</p>
