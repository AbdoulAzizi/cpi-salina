...
<!-- Module Presta Blog -->
<div class="verylightgrey autres-actus">
	<div class="container">
	<h2 class="border-light width50-md">Autres <strong>Actualités</strong></h2>
	...
	{foreach from=$news item=news_item name=NewsName}
		<li class="col-md-4">
			<div class="row">
				...
				<div class="block_gauche col-sm-4 col-md-12">
				...
				{/if}
				<div class="block_droite col-sm-8 col-md-12">
