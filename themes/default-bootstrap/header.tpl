...
<html{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}>
	<head>
		<meta charset="utf-8" />
		{*<title>CPI-SALINA, le spécialiste de vos solutions de pompage{*$meta_title|escape:'html':'UTF-8'}</title>*}
		...
		<!-- Slick -->
		<link rel="stylesheet" href="{$css_dir}slick.css" type="text/css"/>
		<link rel="stylesheet" href="{$css_dir}slick-theme.css" type="text/css"/>
